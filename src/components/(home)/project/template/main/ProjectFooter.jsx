export default function ProjectFooter () {
    return (
        <footer style={{fontFamily: 'Space Grotesk', fontSize: 20}} className="fixed pt-[68px] left-0 w-full z-10 text-center py-4 text-l text-gray-500 flex flex-row justify-between items-center gap-3 relative">
